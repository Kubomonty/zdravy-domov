...
export const RenoventS150 = () => (
  <div>
    ...
    <H3>Renovent Sky 150</H3>
    <Maintext>
      Rekuperačné jednotky produktovej rady Renovent Sky sú určené na inštaláciu predovšetkým v horizontálnom smere na strop.
      Renovent Sky 150 vďaka svojej jedinečnej konštrukčnej výške iba 20cm je zvlášť vhodná do menších bytov s obmedzeným priestorom.
      K Renovent Sky 150 je možné dodať praktický izolovaný kombinovaný rozdeľovací box, ktorý spĺňa i funkciu tlmiča hluku.
      ...
      rovnotlaké vetranie a spolu s protiprúdovým výmenníkom najvyššiu účinnosť rekuperácie tepla z odpadového vzduchu. Jednotky sú dodávané i
      vo verzii PLUS s rozšírenou elektronickou kartou s programovateľnými vstupmi. K dispozícii je logický vstup ON/OFF a napäťový vstup 0-10V,
      ktoré je možné využiť na ďalšie pripojenia, napríklad možnosť pripojenia senzorov CO<sub>2</sub> alebo zemného výmenníka. Produktová rada Renovent Sky
      štandardne obsahuje inteligentnú protimrazovú ochranu a obtokovú by-pass klapku.
    </Maintext>

    <H3>Info</H3>
    <Maintext>- výkon max. 150 m<sup>3</sup>/h pri 150 Pa</Maintext>
    ...
    <Row>
      <Col xs={4}></Col>
      <Col xs={4}><TabText><b>Renovent Sky 150</b></TabText></Col>
      <Col xs={4}><TabText><b>Renovent ESky 150 PLUS</b></TabText></Col>
    </Row>
    <TabRow>
      <Col xs={4}><TabText>Vzduchový výkon</TabText></Col>
      <Col xs={4}><TabText>Max. 150 m<sup>3</sup>/h</TabText></Col>
      <Col xs={4}><TabText>Max. 150 m<sup>3</sup>/h</TabText></Col>
    </TabRow>
    <TabRow>
    ...
    <TabRow>
      ...
      <Col xs={4}><TabText>38W pri 105 m<sup>3</sup>/h (50 Pa)</TabText></Col>
      <Col xs={4}><TabText>38W pri 105 m<sup>3</sup>/h (50 Pa)</TabText></Col>
    </TabRow>
    <TabRow>
      <Col xs={4}><TabText>Spotreba podľa PHI</TabText></Col>
      <Col xs={4}><TabText>0,44 Wh/m<sup>3</sup></TabText></Col>
      <Col xs={4}><TabText>0,44 Wh/m<sup>3</sup></TabText></Col>
    </TabRow>
    <TabRow>
