...
export const RenoventE450 = () => (
  <div>
    ...
    <Maintext>
      ...
      najvyššiu účinnosť rekuperácie tepla z odpadového vzduchu. Produktová rada Renovent Excellent je k dispozícii vo verzii
    ...
    <H3>Info</H3>
    <Maintext>- výkon max. 450 m<sup>3</sup>/h pri 150 Pa</Maintext>
    ...
    <Row>
      <Col xs={4}></Col>
      <Col xs={4}><TabText><b>Renovent Excellent 450</b></TabText></Col>
      <Col xs={4}><TabText><b>Renovent Excellent 450 PLUS</b></TabText></Col>
    </Row>
    <TabRow>
      <Col xs={4}><TabText>Vzduchový výkon</TabText></Col>
      <Col xs={4}><TabText>Max. 450 m<sup>3</sup>/h</TabText></Col>
      <Col xs={4}><TabText>Max. 450 m<sup>3</sup>/h</TabText></Col>
    </TabRow>
    <TabRow>
    ...
    <TabRow>
      ...
      <Col xs={4}><TabText>104W pri 300 m<sup>3</sup>/h (125 Pa)</TabText></Col>
      <Col xs={4}><TabText>104W pri 300 m<sup>3</sup>/h (125 Pa)</TabText></Col>
    </TabRow>
    <TabRow>
    ...
    <TabRow>
      ...
      <Col xs={4}><TabText>DIBt, TNO - EN308, EUROVENT</TabText></Col>
      <Col xs={4}><TabText>DIBt, TNO - EN308, EUROVENT</TabText></Col>
    </TabRow>
    <TabRow>
      <Comment>
