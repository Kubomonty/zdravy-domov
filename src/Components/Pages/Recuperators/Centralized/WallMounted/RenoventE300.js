...
export const RenoventE300 = () => (
  <div>
    ...
    <Maintext>
      ...
      výmenníkom najvyššiu účinnosť rekuperácie tepla z odpadového vzduchu. Produktová rada Renovent Excellent je k dispozícii vo verzii
      pravostrannej i ľavostrannej so 4 hornými pripojeniami alebo s 2 hornými a 2 dolnými pripojeniami. Okrem štandardnej verzie,
      Renovent Excellent sa vyrába vo verzii PLUS. Modely PLUS sú vybavené rozšírenou elektronickou kartou s programovateľnými vstupmi.
      K dispozícii je logický vstup ON/OFF a napäťový vstup 0-10V, ktoré je možné využiť na ďalšie pripojenia, napríklad možnosť
      pripojenia senzorov CO<sub>2</sub> alebo zemného výmenníka. V štandarnej výbave Renovent Excellent
      je inteligentná protimrazová ochrana a obtoková by-pass klapka.
    </Maintext>
    ...
    <Row>
      <Col xs={4}></Col>
      <Col xs={4}><TabText><b>Renovent Excellent 300</b></TabText></Col>
      <Col xs={4}><TabText><b>Renovent Excellent 300 PLUS</b></TabText></Col>
    </Row>
    <TabRow>
    ...
    <TabRow>
      ...
      <Col xs={4}><TabText>40W pri 210 m<sup>3</sup>/h (50 Pa)</TabText></Col>
      <Col xs={4}><TabText>40W pri 210 m<sup>3</sup>/h (50 Pa)</TabText></Col>
    </TabRow>
    <TabRow>
      <Col xs={4}><TabText>Spotreba podľa PHI</TabText></Col>
      <Col xs={4}><TabText>0,26 Wm<sup>3</sup></TabText></Col>
      <Col xs={4}><TabText>0,26 Wm<sup>3</sup></TabText></Col>
    </TabRow>
    <TabRow>
