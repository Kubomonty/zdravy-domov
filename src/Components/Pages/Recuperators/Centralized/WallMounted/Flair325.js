...
export const Flair325 = () => (
  <div>
    ...
    <H3>Flair 325</H3>
    <Maintext>
      Flair 325 je prvým zariadením produktovej rady FLAIR s maximálnym výkonom 325m<sup>3</sup>/h.
      ...
      budú naďalej aplikované avšak pod novým dizajnom. Takmer všetky komponenty jednotky Flair 325 prešli inováciou.
      Ich sofistikovaná kombinácia zabezpečuje vynikajúcu účinnosť. Nový výmenník tepla Holmak TST 35 s väčším povrchom
      má nižšie tlakové straty a dosahuje vysokú tepelnú účinnosť.
    </Maintext>
    <Maintext>
      Flair 325 je k dispozícii vo verzii pravostrannej i ľavostrannej so 4 hornými pripojeniami alebo s 2 hornými a 2 dolnými pripojeniami.
      ...
      Flair 325 je pripravená na modernú komunikáciu a poskytuje rôzne možnosti napojenia ako ovládanie cez aplikáciu, napojenie na systém správy budovy,
      bezdrôtové ovládanie cez spínače a senzory kvality vzduchu.
    </Maintext>

    <H3>Info</H3>
    <Maintext>- výkon max. 325 m<sup>3</sup>/h pri 150 Pa</Maintext>
    <Maintext>- spotreba jednotky podľa PHI 0,21 Wh/m<sup>3</sup> (0,15Wh/m<sup>3</sup> podľa EN 13141-7:2010)</Maintext>
    <Maintext>- koeficient účinnosti podľa PHI 0,76</Maintext>
    ...
    <Row>
      <Col xs={4}></Col>
      <Col xs={4}><TabText><b>Flair 325</b></TabText></Col>
      <Col xs={4}><TabText><b>Flair 325 PLUS</b></TabText></Col>
    </Row>
    <TabRow>
      <Col xs={4}><TabText>Vzduchový výkon</TabText></Col>
      <Col xs={4}><TabText>Max. 325 m<sup>3</sup>/h</TabText></Col>
      <Col xs={4}><TabText>Max. 325 m<sup>3</sup>/h</TabText></Col>
    </TabRow>
    <TabRow>
    ...
    <TabRow>
      ...
      <Col xs={4}><TabText>21W pri 150 m<sup>3</sup>/h (53 Pa)</TabText></Col>
      <Col xs={4}><TabText>21W pri 150 m<sup>3</sup>/h (53 Pa)</TabText></Col>
    </TabRow>
    <TabRow>
      <Col xs={4}><TabText>Spotreba podľa PHI</TabText></Col>
      <Col xs={4}><TabText>0,21 Wh/m<sup>3</sup></TabText></Col>
      <Col xs={4}><TabText>0,21 Wh/m<sup>3</sup></TabText></Col>
    </TabRow>
    <TabRow>
